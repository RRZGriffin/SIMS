...
<body>
      ...
      <?php 
            ...
            $add = "./sa_researchInfo_update_page.php";
            $edit = "";
                        ...
                        if ($res=mysqli_query($db->con, $sql)) :
                              if (mysqli_num_rows($res)>0) {
                                    ...
                                    while ($rows=mysqli_fetch_assoc($res)) :
                                          ...
                                          ?>
                                                <div class="card m-3">
                                                      <a href="./sa_researchInfo_page.php?id=<?php echo $rows['id']?>" class="btn" style="background-image: url('https://cdn.pixabay.com/photo/2020/04/25/10/15/illustration-5090161_1280.jpg');">
                                                            <div class="card-body">
                                                                  <p>

...
<?php 
            ...
            $title = "Class List";
            $add = "sa_s_class_page_update.php?use=Add";
            $edit = "";
            $add_btn = $sort_btn = $delete_btn = $edit_btn = $search_input =false;
...
?>
                              ...
                              <div class="row mb-3">
                                    <?php echo ($_GET['page'] > 0)? '<a href="./sa_section_page.php?page='. --$page .'" class="col-1 btn btn-primary">Prev</a>' : '<div class="col-1"></div>' ?>
                                    <h3 class="col" ><?php if ($year != 1 && $year != 2) echo $year['sch_year']?></h3>
                                    <?php echo ($year != 1 && $year != 2)? '<a href="./sa_section_page.php?page='.++$_GET['page'].'" class="col-1 btn btn-primary">Next</a>' : '<div class="col-1"></div>'?>
                              </div>
<?php
                              if ($year != 1 && $year != 2) {
...
?>
                                                                  <a href="./sa_s_class_page.php?id=<?php echo $section_data['id'] ?>" class="border btn text-center rounded m-3 p-0">

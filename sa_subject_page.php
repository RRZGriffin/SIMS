...
<body>
      ...
      <?php 
            ...
            $add = "./sa_su_subjectInfo_page_update.php?use=Add&page=".(isset($_GET['page'])? $_GET['page'] : '' );
            $edit = "";
...
?>
                              ...
                              <div class="row mb-3">
                                    <?php echo ($_GET['page'] > 0)? '<a href="./sa_subject_page.php?page='. --$page .'" class="col-1 btn btn-primary">Prev</a>' : '<div class="col-1"></div>' ?>
                                    <h3 class="col" ><?php if ($year != 1 && $year != 2) echo $year['sch_year']?></h3>
                                    <?php echo ($year != 1 && $year != 2)? '<a href="./sa_subject_page.php?page='.++$_GET['page'].'" class="col-1 btn btn-primary">Next</a>' : '<div class="col-1"></div>'?>
                              </div>
<?php
                              if ($year != 1 && $year != 2) {
...
<?php 
                                                ...
                                                if ($subject != 1 && $subject != 2) {
                                                      ...
                                                      foreach ($subject as $subject) :
                                                            ++$i;
?>
                                                                  <a href="./sa_su_subjectInfo_page.php?id=<?php echo $subject['id']?>" class="border btn text-center rounded m-3 p-0">

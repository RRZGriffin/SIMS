...
<?php 
            ...
            $add = "./sa_s_c_studentinfo_page_update_add.php?use=Add";
            $edit = "./sa_s_class_page_update.php?use=Update&id=".$_GET['id'];
            $edit_btn = $search_input = true; $add_btn = $delete_btn = false;
                  ...
                  <?php
                        ...
                        if($student_data != 1 && $student_data != 2)
                        {
                              foreach ($student_data as $student_data) {
                                    ++$i;
?>
                                          <a href="./sa_s_c_studentInfo_page.php?id=<?php echo $student_data['id'] ?>" class="border btn text-center rounded m-3 p-0">
